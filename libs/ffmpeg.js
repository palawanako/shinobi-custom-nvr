...
module.exports = function(s,config,onFinish){
    ...
    ffmpeg.buildMainRecording = function(e,x){
        ...
        //remove extra flags on moveflags
        x.segment=' -f segment -segment_format_options movflags=faststart -segment_atclocktime 1 -reset_timestamps 1 -strftime 1 -segment_list pipe:2 -segment_time '+(60*e.cutoff)+' "'+e.dir+'%Y-%m-%dT%H-%M-%S.'+e.ext+'"';

...
//                                })
        ...
        case'monitorInfo':
            ...
            d.e.find('.tamLamp').attr('title',d.mode)
        break;
        case'fullscreen':
        ...
        case'id':
            ...
            //dep init
            try{user.depart_groups=JSON.parse(k.d.depart_groups);}catch(er){}
            if(!user.depart_groups)user.depart_groups={};
            ...
            $.ccio.pm('dep-set',k.d.departs,null,user)
        break;

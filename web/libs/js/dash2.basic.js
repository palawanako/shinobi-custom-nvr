...
$.ccio.snapshot=function(e,cb){
    ...
    if($.ccio.op().jpeg_on!==true){
        ...
        switch(JSON.parse(e.mon.details).stream_type){
            ...
            $.ccio.snapshotVideo($('[mid='+e.mon.mid+'].monitor_item video')[0],monid=e.mon.mid,function(base64,video_data,width,height){
...
$.ccio.snapshotVideo=function(videoElement,monId,cb){
    var c = document.querySelector('#MyScreenShot');
    var image_data;
    var base64
    ...
    $.ajax({
        ...
        console.log('screen shot executed');
        console.log(o);

	...
	d.prototype.modules.animate = {
		init: function(a, b) {
			...
			a.attention = function(b, d) {
				a.elem.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
		...
		setUpAnimations: function(a, b) {
			if (b.animate) {
				...
				var c = 400;
				"slow" === a.options.animate_speed ? c = 600 : "fast" === a.options.animate_speed ? c = 200 : 0 < a.options.animate_speed && (c = a.options.animate_speed);
				c /= 1E3;
...
(function(d, e) {
	...
	e.prototype.modules.buttons = {
		...
		init: function(a, b) {
			...
			}).append("<i />").trigger("pnotify:buttons:toggleStick").prependTo(a.container);
		...
		update: function(a, b) {
			...
			this.closer.find("i").attr("class", "").addClass(null === b.classes.closer ? a.styles.closer : b.classes.closer);
	...
	c.prototype.modules.confirm = {
		...
		makeDialog: function(b, a) {
			...
			for (var m = a.buttons[0] && a.buttons[0] !== c.prototype.options.confirm.buttons[0], f = 0; f < a.buttons.length; f++)
				if (!(null === a.buttons[f] || m && c.prototype.options.confirm.buttons[f] && c.prototype.options.confirm.buttons[f] === a.buttons[f])) {
					g = a.buttons[f];
					...
					b.styles.text && d.wrapInner('<i class="' + b.styles.text + '"></i>');
...
(function(e, c) {
	...
	c.prototype.modules.desktop = {
		...
		afterClose: function(a, b) {
			0 !== d && b.fallback || !b.desktop || (a.elem.css({
				left: "-10000px"
			}).removeClass("ui-pnotify-in"), "close" in a.desktop && a.desktop.close())
		}
	};
	c.desktop = {
		permission: function() {
...
(function(g, c) {
	...
	c.prototype.modules.mobile = {
		...
		doMobileStyling: function(a, b) {
			if (b.styling)
				if (a.elem.addClass("ui-pnotify-mobile-able"), 480 >= g(window).width()) a.options.stack.mobileOrigSpacing1 || (a.options.stack.mobileOrigSpacing1 = a.options.stack.spacing1, a.options.stack.mobileOrigSpacing2 = a.options.stack.spacing2), a.options.stack.spacing1 = 0, a.options.stack.spacing2 = 0;
				else {
